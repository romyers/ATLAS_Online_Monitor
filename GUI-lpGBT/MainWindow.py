...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.addTab(self.tab_sca, "sca")
        self.sca_tab_ins = sca_tab(self.tab_sca,self.ser)
...
##########################################################################
        ...
        # self.pushButton_status.clicked.connect(self.save_LpGBT)

        # # button for saving CSM config
        # self.pushButton_CSM_save = QtWidgets.QPushButton(self.tab_3)
        # self.pushButton_CSM_save.setGeometry(QtCore.QRect(50, 340, 191, 41))
        # self.pushButton_CSM_save.setText('Save CSM configuration')
        # self.pushButton_CSM_save.clicked.connect(self.save_LpGBT)

        # #register label
        # self.label_top = QtWidgets.QLabel(self.tab_3)
        # self.label_top.setGeometry(QtCore.QRect(50, 25, 161, 31))
        # # self.label.setObjectName("label")
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.label_top.setText(_translate("MainWindow", "lpGBT Register Setup:"))
        ...
        # self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_4), _translate("MainWindow", "ePortTX (dataOut)"))
        # self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_5), _translate("MainWindow", "ePortRX (dataIn)"))
        # self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_6), _translate("MainWindow", ""))
